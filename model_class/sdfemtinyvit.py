...
class SDFEMTinyVit(nn.Module):
    def __init__(
        ...
        in_channels = 64
        self.sdfem = SDFEM(svd_channels, in_channels)
...
def SDFEMTinyVit_11M(num_classes=10, svd_channels=96):
    return SDFEMTinyVit(
        ...
        window_sizes=[7, 7, 14, 7],
        drop_path_rate=0.1,
        svd_channels=svd_channels
    )


def SDFEMTinyVit_21M(num_classes=10, svd_channels=96):
    return SDFEMTinyVit(
        num_classes=num_classes,
